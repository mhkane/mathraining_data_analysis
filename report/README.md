...
- **`figures/`** — 15 PNGs: cumulative and per-year bar charts (overall + by gender), 2025 gender pies, top-2-by-gender, and box plot of cumulative points per user by year.
